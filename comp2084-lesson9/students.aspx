...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Students</h1>
    <a href="student-details.aspx">Add Students</a>
    <asp:GridView ID="grdStudents" runat="server" cssclass="table table-striped table-hover" autogeneratecolumns="false"  DataKeyNames="StudentID" >
